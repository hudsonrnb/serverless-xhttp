...
// 环境变量
const UUID = process.env.UUID || 'edd49ac9-b0b3-4b24-81af-a441c3787063'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'theresaforhug-toai.hf.space';                   // 域名或ip,留空将自动获取服务器ip
